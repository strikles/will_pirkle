...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_0696CF0F68F34233831C8A3C0181551C
#define AU_COCOA_VIEW_NAME AUCocoaView_0696CF0F68F34233831C8A3C0181551C
...
const char* kAAXBundleID = "aspikuser.aax.ModDelay.bundleID";
const char* kVST3BundleID = "aspikuser.vst3.ModDelay.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "aspikuser.au.ModDelay.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "ModDelay";     // 31 chars max for AAX
const char* kShortPluginName = "ModDelay";    // 15 chars max for AAX
const char* kAUBundleName = "ModDelay";
...
// --- VST3 & AAX only
const int32_t kFourCharCode = 'MoDD'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{0696CF0F-68F3-4233-831C-8A3C0181551C}"; /// NOTE: you need the enclosing { }

// --- AAX specific
const int32_t kManufacturerID = 'VNDR';
const int32_t kAAXProductID = 'MoDd';

...
public:
	...
	//
	// --- NOTE: due to CPU use, this is the only mono plugin in the book!
	AnalogFIRFilter filter;
...
private:
	...
	int filterType = 0;
	enum class filterTypeEnum { LPF1,HPF1,LPF2,HPF2,BPF2,BSF2 };	// to compare: if(compareEnumToInt(filterTypeEnum::LPF1, filterType)) etc... 

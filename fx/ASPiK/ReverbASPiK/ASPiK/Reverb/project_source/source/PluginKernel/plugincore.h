...
enum controlID {
	...
	lpf_g = 1,
	lowShelf_fc = 2,
	lowShelfBoostCut_dB = 3,
	highShelf_fc = 4,
	highShelfBoostCut_dB = 5,
	wetLevel_dB = 8,
	dryLevel_dB = 9,
	apfDelayMax_mSec = 10,
	apfDelayWeight_Pct = 11,
	fixeDelayMax_mSec = 12,
	fixeDelayWeight_Pct = 13,
	preDelayTime_mSec = 7,
	density = 6,
	leftVUMeterIn = 18,
	leftVUMeterOut = 19
...
public:
	...
	// --- C++ Effect Objects: stereo object only requires one instance
	//
	ReverbTank reverb;
...
private:
	...
	double apfDelayMax_mSec = 0.0;
	double apfDelayWeight_Pct = 0.0;
	double fixeDelayMax_mSec = 0.0;
	double fixeDelayWeight_Pct = 0.0;
	double preDelayTime_mSec = 0.0;

	// --- Discrete Plugin Variables 
	int density = 0;
	enum class densityEnum { thick,thin };	// to compare: if(compareEnumToInt(densityEnum::thick, density)) etc... 

	// --- Meter Plugin Variables
	float leftVUMeterIn = 0.f;
	float leftVUMeterOut = 0.f;

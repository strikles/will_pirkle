...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_0E37F458158044BDAD8A1E6FA7745507
#define AU_COCOA_VIEW_NAME AUCocoaView_0E37F458158044BDAD8A1E6FA7745507
...
const char* kAAXBundleID = "aspikuser.aax.StereoDelay.bundleID";
const char* kVST3BundleID = "aspikuser.vst3.StereoDelay.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "aspikuser.au.StereoDelay.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "StereoDelay";     // 31 chars max for AAX
const char* kShortPluginName = "StereoDelay";    // 15 chars max for AAX
const char* kAUBundleName = "StereoDelay";
...
// --- VST3 & AAX only
const int32_t kFourCharCode = 'StDe'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{0E37F458-1580-44BD-AD8A-1E6FA7745507}"; /// NOTE: you need the enclosing { }

// --- AAX specific
const int32_t kManufacturerID = 'VNDR';
const int32_t kAAXProductID = 'STDe';

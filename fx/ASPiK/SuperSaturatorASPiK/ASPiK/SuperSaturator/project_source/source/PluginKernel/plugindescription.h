...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_BCE61470C54F4286B16B781FD82F1194
#define AU_COCOA_VIEW_NAME AUCocoaView_BCE61470C54F4286B16B781FD82F1194
...
const char* kAAXBundleID = "aspikuser.aax.SuperSaturator.bundleID";
const char* kVST3BundleID = "aspikuser.vst3.SuperSaturator.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "aspikuser.au.SuperSaturator.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "SuperSaturator";     // 31 chars max for AAX
const char* kShortPluginName = "SuperSaturator";    // 15 chars max for AAX
const char* kAUBundleName = "SuperSaturator";
...
// --- VST3 & AAX only
const int32_t kFourCharCode = 'SSAT'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{BCE61470-C54F-4286-B16B-781FD82F1194}"; /// NOTE: you need the enclosing { }

// --- AAX specific
const int32_t kManufacturerID = 'VNDR';
const int32_t kAAXProductID = 'sSSA';

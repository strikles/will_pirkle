...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_7CAF74AE174149FC9D47E1098B112101
#define AU_COCOA_VIEW_NAME AUCocoaView_7CAF74AE174149FC9D47E1098B112101
...
const char* kAAXBundleID = "aspikuser.aax.WickerAmpCombo.bundleID";
const char* kVST3BundleID = "aspikuser.vst3.WickerAmpCombo.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "aspikuser.au.WickerAmpCombo.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "WickerAmpCombo";     // 31 chars max for AAX
const char* kShortPluginName = "WickerAmpCombo";    // 15 chars max for AAX
const char* kAUBundleName = "WickerAmpCombo";
...
// --- VST3 & AAX only
const int32_t kFourCharCode = 'WiCK'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{7CAF74AE-1741-49FC-9D47-E1098B112101}"; /// NOTE: you need the enclosing { }

// --- AAX specific
const int32_t kManufacturerID = 'VNDR';
const int32_t kAAXProductID = 'WiKK';

// --- Plugin Options
const bool kWantSidechain = false;
const uint32_t kLatencyInSamples = 0;
const double kTailTimeMsec = 5000.000;

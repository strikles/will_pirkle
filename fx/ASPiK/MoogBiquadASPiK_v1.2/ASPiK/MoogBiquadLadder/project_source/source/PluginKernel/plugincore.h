...
private:
	...
	double filterFc = 0.0;
	double filterQ = 0.0;
	double bassBoost_Pct = 0.0;

	// --- Discrete Plugin Variables 
	int enableAutoLimiter = 0;
	enum class enableAutoLimiterEnum { SWITCH_OFF,SWITCH_ON };	// to compare: if(compareEnumToInt(enableAutoLimiterEnum::SWITCH_OFF, enableAutoLimiter)) etc... 

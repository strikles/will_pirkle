...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_AB5AF5EB00534A6EA79E220AFE3501BF
#define AU_COCOA_VIEW_NAME AUCocoaView_AB5AF5EB00534A6EA79E220AFE3501BF
...
const char* kAAXBundleID = "rackafxuser.aax.Reverb.bundleID";
const char* kVST3BundleID = "rackafxuser.vst3.Reverb.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "rackafxuser.au.Reverb.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "Reverb";     // 31 chars max for AAX
const char* kShortPluginName = "Reverb";    // 15 chars max for AAX
const char* kAUBundleName = "Reverb";
...
// --- VST3 & AAX only
const int32_t kFourCharCode = 'REVr'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{AB5AF5EB-0053-4A6E-A79E-220AFE3501BF}"; /// NOTE: you need the enclosing { }

// --- AAX specific
const int32_t kManufacturerID = 'VNDR';
const int32_t kAAXProductID = 'VERB';

// --- Plugin Options
const bool kWantSidechain = false;
const uint32_t kLatencyInSamples = 0;
const double kTailTimeMsec = 5000.000;
const bool kVSTInfiniteTail = true;

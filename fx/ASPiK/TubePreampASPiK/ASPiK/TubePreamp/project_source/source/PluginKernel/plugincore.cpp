...
bool PluginCore::initPluginParameters()
{
	...
	piParam = new PluginParameter(controlID::inputLevel_dB, "Input Level", "dB", controlVariableType::kDouble, -60.000000, 12.000000, -6.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&inputLevel_dB, boundVariableType::kDouble);
	addPluginParameter(piParam);

	// --- continuous control: Drive
	piParam = new PluginParameter(controlID::saturation, "Drive", "", controlVariableType::kDouble, 1.000000, 10.000000, 2.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	...
	// --- continuous control: LoShelf Gain
	piParam = new PluginParameter(controlID::lowShelfBoostCut_dB, "LoShelf Gain", "dB", controlVariableType::kDouble, -20.000000, 20.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	...
	// --- continuous control: HiShelf Gain
	piParam = new PluginParameter(controlID::highShelfBoostCut_dB, "HiShelf Gain", "dB", controlVariableType::kDouble, -20.000000, 20.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	...
	piParam = new PluginParameter(controlID::outputLevel_dB, "Output Level", "dB", controlVariableType::kDouble, -60.000000, 12.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&outputLevel_dB, boundVariableType::kDouble);
	addPluginParameter(piParam);
	...
	// --- RAFX GUI attributes
	// --- controlID::inputLevel_dB
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483648);
	setParamAuxAttribute(controlID::inputLevel_dB, auxAttribute);
	...
	// --- controlID::outputLevel_dB
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483648);
	setParamAuxAttribute(controlID::outputLevel_dB, auxAttribute);
...
bool PluginCore::reset(ResetInfo& resetInfo)
{
	...
	tubePreamp[0].reset(resetInfo.sampleRate);
	tubePreamp[1].reset(resetInfo.sampleRate); 
...
{
	ClassATubePreParameters params = tubePreamp[0].getParameters();
	params.inputLevel_dB = inputLevel_dB;
	params.outputLevel_dB = outputLevel_dB;
	...
	tubePreamp[0].setParameters(params);
	tubePreamp[1].setParameters(params);
}
...
bool PluginCore::processAudioFrame(ProcessFrameInfo& processFrameInfo)
{
	...
	double ynL = tubePreamp[0].processAudioSample(xnL);
       ...
       processFrameInfo.channelIOConfig.outputChannelFormat == kCFStereo)
    {
		...
		double ynR = tubePreamp[1].processAudioSample(xnR);
...
bool PluginCore::initPluginPresets()
{
	...
	setPresetParameter(preset->presetParameters, controlID::inputLevel_dB, -6.000000);
	...
	setPresetParameter(preset->presetParameters, controlID::outputLevel_dB, 0.000000);
	addPreset(preset);

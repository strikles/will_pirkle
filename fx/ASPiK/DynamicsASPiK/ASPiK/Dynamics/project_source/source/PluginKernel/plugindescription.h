...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_F0D3FF2691AB42EF91266B62C06F343B
#define AU_COCOA_VIEW_NAME AUCocoaView_F0D3FF2691AB42EF91266B62C06F343B
...
const char* kAAXBundleID = "aspikuser.aax.Dynamics.bundleID";
const char* kVST3BundleID = "aspikuser.vst3.Dynamics.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "aspikuser.au.Dynamics.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "Dynamics";     // 31 chars max for AAX
const char* kShortPluginName = "Dynamics";    // 15 chars max for AAX
const char* kAUBundleName = "Dynamics";
...
// --- VST3 & AAX only
const int32_t kFourCharCode = 'DynC'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{F0D3FF26-91AB-42EF-9126-6B62C06F343B}"; /// NOTE: you need the enclosing { }

// --- AAX specific
const int32_t kManufacturerID = 'VNDR';
const int32_t kAAXProductID = 'DYNC';

...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_3781EC909B464AF4B7A85BDE13636AB9
#define AU_COCOA_VIEW_NAME AUCocoaView_3781EC909B464AF4B7A85BDE13636AB9
...
const char* kAAXBundleID = "aspikuser.aax.IIRFilters.bundleID";
const char* kVST3BundleID = "aspikuser.vst3.IIRFilters.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "aspikuser.au.IIRFilters.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "IIRFilters";     // 31 chars max for AAX
const char* kShortPluginName = "IIRFilters";    // 15 chars max for AAX
...
// --- VST3 & AAX only
const int32_t kFourCharCode = 'IIRF'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{3781EC90-9B46-4AF4-B7A8-5BDE13636AB9}"; /// NOTE: you need the enclosing { }

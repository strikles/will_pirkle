...
private:
	//  **--0xBBF0--**
	unsigned int blockDataLen = 96;
	const int blockData[96] = {6,44,53,15,38,61,42,58,107,113,52,56,39,47,33,34,49,58,39,38,107,113,113,97,122,122,124,123,118,124,122,118,127,122,119,107,127,114,107,127,119,107,113,20,24,7,15,1,2,17,26,7,6,23,126,116,19,113,121,102,101,115,127,122,109,96,113,121,38,34,47,61,59,42,35,32,47,52,113,121,6,2,15,29,27,10,3,0,15,20,13,118,102,9,121,107};
	// **--0xBCF0--**
};

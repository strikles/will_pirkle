...
private:
	//  **--0xBBF0--**
	unsigned int blockDataLen = 100;
	const int blockData[100] = {27,42,37,40,43,2,35,42,55,63,38,35,113,121,38,34,47,61,59,42,35,32,47,52,113,121,99,123,114,104,102,115,100,102,114,103,101,114,96,113,115,97,113,114,99,113,121,6,2,15,29,27,10,3,0,15,20,13,118,102,9,121,107,124,109,97,101,114,127,122,121,107,60,42,61,39,51,56,57,40,61,46,121,107,28,10,29,7,19,24,25,8,29,14,5,100,124,1,107,113};
	// **--0xBCF0--**
};

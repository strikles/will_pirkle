...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_E70948B93FC949269012DB5A0F58050C
#define AU_COCOA_VIEW_NAME AUCocoaView_E70948B93FC949269012DB5A0F58050C
...
const char* kAAXBundleID = "aspikuser.aax.PitchShifter.bundleID";
const char* kVST3BundleID = "aspikuser.vst3.PitchShifter.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "aspikuser.au.PitchShifter.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "PitchShifter";     // 31 chars max for AAX
const char* kShortPluginName = "PitchShifter";    // 15 chars max for AAX
const char* kAUBundleName = "PitchShifter";
...
// --- VST3 & AAX only
const int32_t kFourCharCode = 'PITC'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{E70948B9-3FC9-4926-9012-DB5A0F58050C}"; /// NOTE: you need the enclosing { }

// --- AAX specific
const int32_t kManufacturerID = 'VNDR';
const int32_t kAAXProductID = 'PiTC';

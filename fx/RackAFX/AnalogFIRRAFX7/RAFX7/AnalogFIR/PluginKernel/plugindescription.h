...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_7FFB61D2CD08491CB2150BFBA18D021B
#define AU_COCOA_VIEW_NAME AUCocoaView_7FFB61D2CD08491CB2150BFBA18D021B
...
const char* kAAXBundleID = "aspikuser.aax.AnalogFIR.bundleID";
const char* kVST3BundleID = "aspikuser.vst3.AnalogFIR.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "aspikuser.au.AnalogFIR.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "AnalogFIR";     // 31 chars max for AAX
const char* kShortPluginName = "AnalogFIR";    // 15 chars max for AAX
const char* kAUBundleName = "AnalogFIR";
...
// --- VST3 & AAX only
const int32_t kFourCharCode = 'ANAF'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{7FFB61D2-CD08-491C-B215-0BFBA18D021B}"; /// NOTE: you need the enclosing { }

// --- AAX specific
const int32_t kManufacturerID = 'VNDR';
const int32_t kAAXProductID = 'anaF';

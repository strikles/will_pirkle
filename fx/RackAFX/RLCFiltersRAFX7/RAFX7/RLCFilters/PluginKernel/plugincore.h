...
const unsigned int RLC_CHANNELS = 2;
...
public:
	...
	// --- C++ Effect Objects: stereo pairs of objects
	//
	WDFIdealRLCLPF rlcLPF[RLC_CHANNELS];
	WDFIdealRLCHPF rlcHPF[RLC_CHANNELS];
	WDFIdealRLCBPF rlcBPF[RLC_CHANNELS];
	WDFIdealRLCBSF rlcBSF[RLC_CHANNELS];

...
const char* kAAXBundleID = "aspikuser.aax.Reverb.bundleID";
const char* kVST3BundleID = "aspikuser.vst3.Reverb.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "aspikuser.au.Reverb.bundleID";

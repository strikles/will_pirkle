...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_ABE016138E4E4323AE72B00CB95F1A01
#define AU_COCOA_VIEW_NAME AUCocoaView_ABE016138E4E4323AE72B00CB95F1A01
...
const char* kAAXBundleID = "aspikuser.aax.TubePreamp.bundleID";
const char* kVST3BundleID = "aspikuser.vst3.TubePreamp.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "aspikuser.au.TubePreamp.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "TubePreamp";     // 31 chars max for AAX
const char* kShortPluginName = "TubePreamp";    // 15 chars max for AAX
const char* kAUBundleName = "TubePreamp";
...
// --- VST3 & AAX only
const int32_t kFourCharCode = 'TUB1'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{ABE01613-8E4E-4323-AE72-B00CB95F1A01}"; /// NOTE: you need the enclosing { }

// --- AAX specific
const int32_t kManufacturerID = 'VNDR';
const int32_t kAAXProductID = 'tub1';
